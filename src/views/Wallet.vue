<template>
  ...
  <b-card class="mt-3" bg-variant="light">
    ...
    <b-card class="mt-3" bg-variant="light">
    <div> {{ Balance / Math.pow(10,18) }} ARK</div> 
    </b-card>
    </b-col>
    ...
    <b-col cols="6" class="mt-3">
    <b-card class="mt-3" bg-variant="light">
    <div> {{ EthPrice/100*Balance / Math.pow(10,18) }} $ ARK</div> 
    </b-card>
    </b-col>
    ...
    <b-card class="mt-3" bg-variant="light">
       ...
       <b-button variant="light" v-b-modal.modal-prevent-closing size="md">
              <b-icon icon="bag-plus"></b-icon> Buy ARK
            </b-button>
            <b-modal
            ...
            >
              <form ref="form" @submit.stop.prevent="handleSubmit">
                ...
                >
                  ...
                  <div>{{ 10 * amount }} ARK</div>
                </b-form-group>
              </form>
            </b-modal>

        <b-button variant="light" v-b-modal.modal-set-sell size="md">
           <b-icon icon="bag-dash"></b-icon> Sell ARK
            </b-button>
            <b-modal
              id="modal-set-sell"
              ref="modal"
